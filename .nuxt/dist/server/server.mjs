import { shallowReactive, getCurrentInstance, defineAsyncComponent, version, inject, ref, watchEffect, watch, unref, toRef, isRef, nextTick, shallowRef, computed, reactive, isReadonly, defineComponent, h, resolveComponent, onScopeDispose, createVNode, resolveDynamicComponent, mergeProps, withCtx, renderSlot, useSSRContext, createTextVNode, toDisplayString, withAsyncContext, openBlock, createBlock, createCommentVNode, createElementBlock, Fragment as Fragment$1, Suspense, Transition, provide, onErrorCaptured, onServerPrefetch, createApp } from "vue";
...
import { hasProtocol, parseURL, joinURL, isEqual, parseQuery, withTrailingSlash, withoutTrailingSlash, withBase, withLeadingSlash } from "ufo";
...
const components = {
  ...
  DocumentDrivenNotFound: /* @__PURE__ */ defineAsyncComponent(() => import(
    "./_nuxt/DocumentDrivenNotFound-77302a73.js"
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/document-driven-a2015239.js").then((m) => m.default || m)
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/empty-5f0cb977.js").then((m) => m.default || m)
  }
];
...
const createQueryFetch = () => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import("./_nuxt/client-db-724c8739.js").then((m) => m.useContentDatabase());
...
const fetchContentNavigation = async (queryBuilder) => {
  ...
  if (shouldUseClientDB()) {
    const generateNavigation = await import("./_nuxt/client-db-724c8739.js").then((m) => m.generateNavigation);
...
const layouts = {
  article: () => import("./_nuxt/article-91195ceb.js").then((m) => m.default || m),
  default: () => import("./_nuxt/default-77195937.js").then((m) => m.default || m),
  page: () => import("./_nuxt/page-42ade6df.js").then((m) => m.default || m)
};
...
const preview_detector_wuXocrN5Sn = /* @__PURE__ */ defineNuxtPlugin((nuxtApp) => {
  ...
  async function initializePreview() {
    const useStudio = await import("./_nuxt/useStudio-52c67077.js").then((m) => m.useStudio);
...
const AppLoadingBar_vue_vue_type_style_index_0_lang = "";
const _sfc_main$b = {
...
const MainNav_vue_vue_type_style_index_0_scoped_92df8ecc_transformed_true_lang = "";
...
const AppHeader_vue_vue_type_style_index_0_scoped_bac1380c_transformed_true_lang = "";
...
const SocialIcons_vue_vue_type_style_index_0_scoped_7a4dc737_transformed_true_lang = "";
...
const ColorModeSwitch_vue_vue_type_style_index_0_scoped_4743d311_transformed_true_lang = "";
...
const AppFooter_vue_vue_type_style_index_0_scoped_2e0b0b29_transformed_true_lang = "";
...
const AppLayout_vue_vue_type_style_index_0_scoped_19c29c62_transformed_true_lang = "";
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const ErrorComponent = /* @__PURE__ */ defineAsyncComponent(() => import("./_nuxt/error-component-e32e0a00.js").then((r) => r.default || r));
    const IslandRenderer = /* @__PURE__ */ defineAsyncComponent(() => import("./_nuxt/island-renderer-9e1e0f22.js").then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
...
export {
  ...
  usePinceauRuntime as f,
  useUnwrap as g,
  __nuxt_component_1$1 as h,
  computedStyle as i,
  useColorMode as j,
  usePinceauTheme as k,
  useRoute as l,
  useContentHead as m,
  useState as n,
  useContent as o,
