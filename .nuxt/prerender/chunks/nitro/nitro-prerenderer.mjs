...
import { defineEventHandler, handleCacheHeaders, createEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, getRequestHeader, setResponseStatus, setResponseHeader, getRequestHeaders, appendHeader, createError, getQuery, getCookie, createApp, createRouter as createRouter$1, toNodeListener, fetchWithEvent, lazyEventHandler } from 'file:///home/holydiver/Documents/FIE/nuxt/blog/node_modules/h3/dist/index.mjs';
import { createFetch as createFetch$1, Headers } from 'file:///home/holydiver/Documents/FIE/nuxt/blog/node_modules/ofetch/dist/node.mjs';
import destr from 'file:///home/holydiver/Documents/FIE/nuxt/blog/node_modules/destr/dist/index.mjs';
import { createCall, createFetch } from 'file:///home/holydiver/Documents/FIE/nuxt/blog/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file:///home/holydiver/Documents/FIE/nuxt/blog/node_modules/hookable/dist/index.mjs';
import { snakeCase, pascalCase, kebabCase, camelCase } from 'file:///home/holydiver/Documents/FIE/nuxt/blog/node_modules/scule/dist/index.mjs';
import defu, { defuFn } from 'file:///home/holydiver/Documents/FIE/nuxt/blog/node_modules/defu/dist/defu.mjs';
import { hash } from 'file:///home/holydiver/Documents/FIE/nuxt/blog/node_modules/ohash/dist/index.mjs';
import { parseURL, withoutBase, joinURL, withQuery, withLeadingSlash, withoutTrailingSlash, isRelative } from 'file:///home/holydiver/Documents/FIE/nuxt/blog/node_modules/ufo/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///home/holydiver/Documents/FIE/nuxt/blog/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///home/holydiver/Documents/FIE/nuxt/blog/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file:///home/holydiver/Documents/FIE/nuxt/blog/node_modules/radix3/dist/index.mjs';
import { extname, join } from 'file:///home/holydiver/Documents/FIE/nuxt/blog/node_modules/pathe/dist/index.mjs';
import { unified } from 'file:///home/holydiver/Documents/FIE/nuxt/blog/node_modules/unified/index.js';
import { toString } from 'file:///home/holydiver/Documents/FIE/nuxt/blog/node_modules/mdast-util-to-string/index.js';
import { preprocess } from 'file:///home/holydiver/Documents/FIE/nuxt/blog/node_modules/micromark/lib/preprocess.js';
import { postprocess } from 'file:///home/holydiver/Documents/FIE/nuxt/blog/node_modules/micromark/lib/postprocess.js';
import { stringifyPosition } from 'file:///home/holydiver/Documents/FIE/nuxt/blog/node_modules/unist-util-stringify-position/index.js';
import { markdownLineEnding, markdownSpace } from 'file:///home/holydiver/Documents/FIE/nuxt/blog/node_modules/micromark-util-character/index.js';
import { push, splice } from 'file:///home/holydiver/Documents/FIE/nuxt/blog/node_modules/micromark-util-chunked/index.js';
import { resolveAll } from 'file:///home/holydiver/Documents/FIE/nuxt/blog/node_modules/micromark-util-resolve-all/index.js';
import remarkEmoji from 'file:///home/holydiver/Documents/FIE/nuxt/blog/node_modules/remark-emoji/index.js';
import rehypeSlug from 'file:///home/holydiver/Documents/FIE/nuxt/blog/node_modules/rehype-slug/index.js';
import remarkSqueezeParagraphs from 'file:///home/holydiver/Documents/FIE/nuxt/blog/node_modules/remark-squeeze-paragraphs/index.js';
import rehypeExternalLinks from 'file:///home/holydiver/Documents/FIE/nuxt/blog/node_modules/rehype-external-links/index.js';
import remarkGfm from 'file:///home/holydiver/Documents/FIE/nuxt/blog/node_modules/remark-gfm/index.js';
import rehypeSortAttributeValues from 'file:///home/holydiver/Documents/FIE/nuxt/blog/node_modules/rehype-sort-attribute-values/index.js';
import rehypeSortAttributes from 'file:///home/holydiver/Documents/FIE/nuxt/blog/node_modules/rehype-sort-attributes/index.js';
import rehypeRaw from 'file:///home/holydiver/Documents/FIE/nuxt/blog/node_modules/rehype-raw/index.js';
import remarkMDC, { parseFrontMatter } from 'file:///home/holydiver/Documents/FIE/nuxt/blog/node_modules/remark-mdc/dist/index.mjs';
import remarkParse from 'file:///home/holydiver/Documents/FIE/nuxt/blog/node_modules/remark-parse/index.js';
import remark2rehype from 'file:///home/holydiver/Documents/FIE/nuxt/blog/node_modules/remark-rehype/index.js';
import { all } from 'file:///home/holydiver/Documents/FIE/nuxt/blog/node_modules/mdast-util-to-hast/index.js';
import { detab } from 'file:///home/holydiver/Documents/FIE/nuxt/blog/node_modules/detab/index.js';
import { u } from 'file:///home/holydiver/Documents/FIE/nuxt/blog/node_modules/unist-builder/index.js';
import { encode } from 'file:///home/holydiver/Documents/FIE/nuxt/blog/node_modules/mdurl/index.js';
import slugify from 'file:///home/holydiver/Documents/FIE/nuxt/blog/node_modules/slugify/slugify.js';
import { position } from 'file:///home/holydiver/Documents/FIE/nuxt/blog/node_modules/unist-util-position/index.js';
import { visit } from 'file:///home/holydiver/Documents/FIE/nuxt/blog/node_modules/unist-util-visit/index.js';
import { BUNDLED_LANGUAGES, BUNDLED_THEMES, getHighlighter } from 'file:///home/holydiver/Documents/FIE/nuxt/blog/node_modules/shiki-es/dist/shiki.node.mjs';
import consola from 'file:///home/holydiver/Documents/FIE/nuxt/blog/node_modules/unenv/runtime/npm/consola.mjs';

const defineAppConfig = (config) => config;

const appConfig0 = defineAppConfig({
  alpine: {
    title: "Oleg R\xF5bnikov",
    ...
    header: {
      ...
      logo: {
        ...
        alt: "Oleg R\xF5bnikov Web Development"
        // alt of the logo
      }
    },
    footer: {
...
const serverAssets = [{"baseName":"server","dir":"/home/holydiver/Documents/FIE/nuxt/blog/server/assets"}];
...
storage.mount('pinceau', unstorage_47drivers_47fs({"driver":"fs","base":"/home/holydiver/Documents/FIE/nuxt/blog/.nuxt/pinceau/theme","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('content:source:content', unstorage_47drivers_47fs({"name":"content:source:content","driver":"fs","base":"/home/holydiver/Documents/FIE/nuxt/blog/content","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache:content', unstorage_47drivers_47fs({"driver":"fs","base":"/home/holydiver/Documents/FIE/nuxt/blog/.nuxt/content-cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/home/holydiver/Documents/FIE/nuxt/blog","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/home/holydiver/Documents/FIE/nuxt/blog/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/home/holydiver/Documents/FIE/nuxt/blog/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/home/holydiver/Documents/FIE/nuxt/blog/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _aSHbdYAxML = (function(nitro) {
...
const _20Uu1y = eventHandler(async (event) => {
...
const _RGOuDt = defineEventHandler((event) => {
  ...
  parse: async (_id, content) => {
    ...
    if (typeof content === "string") {
      if (_id.endsWith("json5")) {
        parsed = (await import('file:///home/holydiver/Documents/FIE/nuxt/blog/node_modules/json5/lib/index.js').then((m) => m.default || m)).parse(content);
...
const _jVmoNB = defineEventHandler(async (event) => {
...
const _LFS6h2 = defineEventHandler(async (event) => {
...
const _Taz46P = defineEventHandler(async (event) => {
  const query = getContentQuery(event);
...
const _lazy_e9fDRV = () => import('../renderer.mjs');

const handlers = [
  { route: '/__studio.json', handler: _20Uu1y, lazy: false, middleware: false, method: "get" },
  { route: '/api/component-meta', handler: _RGOuDt, lazy: false, middleware: false, method: "get" },
  { route: '/api/component-meta/:component?', handler: _RGOuDt, lazy: false, middleware: false, method: "get" },
  ...
  { route: '/api/_content/cache.1682090620511.json', handler: _LFS6h2, lazy: false, middleware: false, method: "get" },
  ...
  { route: '/**', handler: _lazy_e9fDRV, lazy: true, middleware: false, method: undefined }
];
